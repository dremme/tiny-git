 ...
 */
fun createMacWindow(window: Stage) =
    menu {
...
private fun createMacZoom(window: Stage) =
    menuItem {
...
private fun createMacMinimize(window: Stage) =
    menuItem {
        shortcut = "Shortcut+M"
...
private fun createMacFullscreen(window: Stage) =
    menuItem {
